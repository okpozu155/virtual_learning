...
class _LibraryScreenState extends State<LibraryScreen> {
  final SlideRepository repository = SlideRepository();
  ...
  Future<void> loadSlides() async {
    try {
      ...
      debugPrint("Load Slides Error: $e");
  ...
  Future<void> downloadSlide(
    ...
    try {
      await OfflineSlideService().downloadSlide(
        slide.id,
        slide.imageUrl,
      );
